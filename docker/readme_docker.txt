...
5. Call the container something sensible (i.e. parents), set the host port to 8787, and add an Environment variable called PASSWORD with the value: pass
...
git clone https://github.com/yl2944/parental-mentalization-across-cultures-.git
This will download the repository to a folder called parental-mentalization-across-cultures-
